    ...
    try:
        ...
        if button_id == 'btn-ver-2' and n2 and n2 > 0:
            ...
            try:
                ...
                print(f"{'='*50}\n")
                return layout_v2, 'v2', "🌙 Night 모드 활성화", f"🌙 Night 버튼이 클릭되었습니다! (클릭 수: {n2})"
                ...
                layout_v1 = create_layout_v1(INITIAL_PORT_OPTIONS, selected_port, INITIAL_PORT_VALUE)
                return layout_v1, 'v1', "☀️ Day 모드 (오류로 인한 복원)", "❌ Night 모드 오류 발생"
        ...
        # Day 모드 버튼 클릭 또는 기본값 처리
            ...
            print(f"{'='*50}\n")
            if button_id == 'btn-ver-1' and n1 and n1 > 0:
                return layout_v1, 'v1', "☀️ Day 모드 활성화", f"☀️ Day 버튼이 클릭되었습니다! (클릭 수: {n1})"
            else:
                return layout_v1, 'v1', "☀️ Day 모드 (기본)", "애플리케이션 시작"
        ...
        print(f"{'='*50}\n")
        # 오류 발생 시 기본 레이아웃 반환
        return create_layout_v1(INITIAL_PORT_OPTIONS, selected_port, INITIAL_PORT_VALUE), 'v1', "❌ 오류 발생 (Day 모드로 복원)", "❌ 시스템 오류 발생"
